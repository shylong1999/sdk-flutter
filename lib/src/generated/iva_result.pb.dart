...
class ResultResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ResultResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'iva_result'), createEmptyInstance: create)
    ...
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'forwardData')
    ..hasRequiredFields = false
  ;
  ...
  factory ResultResponse({
    ...
    if (forwardData != null) {
      _result.forwardData = forwardData;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(6)
  $core.String get forwardData => $_getSZ(5);
  @$pb.TagNumber(6)
  set forwardData($core.String v) { $_setString(5, v); }
  @$pb.TagNumber(6)
  $core.bool hasForwardData() => $_has(5);
  @$pb.TagNumber(6)
  void clearForwardData() => clearField(6);
}
...
class EventResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EventResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'iva_result'), createEmptyInstance: create)
    ...
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'forwardData')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(9)
  $core.String get forwardData => $_getSZ(8);
  @$pb.TagNumber(9)
  set forwardData($core.String v) { $_setString(8, v); }
  @$pb.TagNumber(9)
  $core.bool hasForwardData() => $_has(8);
  @$pb.TagNumber(9)
  void clearForwardData() => clearField(9);
}
