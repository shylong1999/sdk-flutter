...
const ResultResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'forward_data', '3': 6, '4': 1, '5': 9, '10': 'forwardData'},
  ],
};

/// Descriptor for `ResultResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List resultResponseDescriptor = $convert.base64Decode('');
...
const EventResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'forward_data', '3': 9, '4': 1, '5': 9, '10': 'forwardData'},
  ],
};

/// Descriptor for `EventResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List eventResponseDescriptor = $convert.base64Decode('');
